namespace FileSystemModels.Models
{
  ...
  public class BrowseNavigation : IBrowseNavigation
  {
    ...
    {
      this.RecentFolders = new System.Collections.Generic.Stack<PathModel>();
      this.FutureFolders = new System.Collections.Generic.Stack<PathModel>();
    }
    ...
    /// </summary>
    public PathModel CurrentFolder { get; private set; }

    /// <summary>
    /// Gets/sets the undo stacks for navigation.
    /// </summary>
    private System.Collections.Generic.Stack<PathModel> RecentFolders { get; set; }

    /// <summary>
    /// Gets/sets the redo stack for navigation.
    /// </summary>
    private System.Collections.Generic.Stack<PathModel> FutureFolders { get; set; }
    ...
    /// </summary>
    PathModel IBrowseNavigation.BrowseForward()
    {
    ...
    /// </summary>
    PathModel IBrowseNavigation.BrowseUp()
    {
